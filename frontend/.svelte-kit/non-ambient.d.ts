...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/(user)" | "/(registration)" | "/(app)" | "/" | "/admin" | "/admin/masters" | "/admin/profile" | "/admin/users" | "/admin/workshops" | "/(registration)/login" | "/(registration)/logout" | "/(user)/orders" | "/(user)/orders/[id]" | "/(user)/profile" | "/(user)/schedule" | "/(user)/schedule/[id]" | "/(registration)/signup";
		RouteParams(): {
		...
		Pathname(): "/" | "/admin" | "/admin/" | "/admin/masters" | "/admin/masters/" | "/admin/profile" | "/admin/profile/" | "/admin/users" | "/admin/users/" | "/admin/workshops" | "/admin/workshops/" | "/login" | "/login/" | "/logout" | "/logout/" | "/orders" | "/orders/" | `/orders/${string}` & {} | `/orders/${string}/` & {} | "/profile" | "/profile/" | "/schedule" | "/schedule/" | `/schedule/${string}` & {} | `/schedule/${string}/` & {} | "/signup" | "/signup/";
